"""Environment validation for LocalImageProcessing dependencies."""
...
def format_environment_errors(issues: Iterable[EnvironmentIssue]) -> str:
    lines = [
        "LocalImageProcessing environment is incomplete.",
        "Run .\\script\\Initialize-Env.ps1 from the ImageTranslation repository,",
        "then retry: python -m LocalImageProcessing check-env",
        "",
        "Failures:",
    ]
    for issue in issues:
